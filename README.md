...
pytest tests/ -v       # run the test suite (207 tests)
```
...
- **Phase 7 (world model) — done:** YGGDRASIL typed knowledge graph ([`odin/world/yggdrasil.py`](odin/world/yggdrasil.py)),
  NORNS causal/temporal engine ([`odin/world/norns.py`](odin/world/norns.py)),
  and VÖLVA simulation ([`odin/world/volva.py`](odin/world/volva.py)) with what-if rollouts and action comparison.
- **Next:** Phase 8 (multi-agent debate), Phases 9–12.
- 207 tests, `ruff` + `mypy` clean.
